...
#endif`,LK=`#if defined( USE_LOGDEPTHBUF )
...
#endif`,wK=`#if defined( USE_MAP ) || defined( USE_ALPHAMAP )
...
void main() {
	...
	`}function XG(J){let Q=new WeakMap,$=null;function Z(X){if(X&&X.isTexture){let K=X.mapping,U=K===W7||K===H7,G=K===j9||K===Z9;if(U||G){let E=Q.get(X),q=E!==void 0?E.texture.pmremVersion:0;if(X.isRenderTargetTexture&&X.pmremVersion!==q){if($===null)$=new h$(J);return E=U?$.fromEquirectangular(X,E):$.fromCubemap(X,E),E.texture.pmremVersion=X.pmremVersion,Q.set(X,E),E.texture}else if(E!==void 0)return E.texture;else{let O=X.image;if(U&&O&&O.height>0||G&&O&&W(O)){if($===null)$=new h$(J);return E=U?$.fromEquirectangular(X):$.fromCubemap(X),E.texture.pmremVersion=X.pmremVersion,Q.set(X,E),X.addEventListener("dispose",H),E.texture}else return null}}}return X}function W(X){let K=0,U=6;for(let G=0;G<U;G++)if(X[G]!==void 0)K++;return K===U}function H(X){let K=X.target;K.removeEventListener("dispose",H);let U=Q.get(K);if(U!==void 0)Q.delete(K),U.dispose()}function Y(){if(Q=new WeakMap,$!==null)$.dispose(),$=null}return{get:Z,dispose:Y}}function KG(J){let Q={};function $(Z){if(Q[Z]!==void 0)return Q[Z];let W;switch(Z){case"WEBGL_depth_texture":W=J.getExtension("WEBGL_depth_texture")||J.getExtension("MOZ_WEBGL_depth_texture")||J.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":W=J.getExtension("EXT_texture_filter_anisotropic")||J.getExtension("MOZ_EXT_texture_filter_anisotropic")||J.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":W=J.getExtension("WEBGL_compressed_texture_s3tc")||J.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||J.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":W=J.getExtension("WEBGL_compressed_texture_pvrtc")||J.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:W=J.getExtension(Z)}return Q[Z]=W,W}return{has:function(Z){return $(Z)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(Z){let W=$(Z);if(W===null)Q9("THREE.WebGLRenderer: "+Z+" extension not supported.");return W}}}function UG(J,Q,$,Z){let W={},H=new WeakMap;function Y(E){let q=E.target;if(q.index!==null)Q.remove(q.index);for(let R in q.attributes)Q.remove(q.attributes[R]);q.removeEventListener("dispose",Y),delete W[q.id];let O=H.get(q);if(O)Q.remove(O),H.delete(q);if(Z.releaseStatesOfGeometry(q),q.isInstancedBufferGeometry===!0)delete q._maxInstanceCount;$.memory.geometries--}function X(E,q){if(W[q.id]===!0)return q;return q.addEventListener("dispose",Y),W[q.id]=!0,$.memory.geometries++,q}function K(E){let q=E.attributes;for(let O in q)Q.update(q[O],J.ARRAY_BUFFER)}function U(E){let q=[],O=E.index,R=E.attributes.position,M=0;if(O!==null){let _=O.array;M=O.version;for(let L=0,w=_.length;L<w;L+=3){let S=_[L+0],C=_[L+1],T=_[L+2];q.push(S,C,C,T,T,S)}}else if(R!==void 0){let _=R.array;M=R.version;for(let L=0,w=_.length/3-1;L<w;L+=3){let S=L+0,C=L+1,T=L+2;q.push(S,C,C,T,T,S)}}else return;let N=new((G$(q))?D7:k7)(q,1);N.version=M;let F=H.get(E);if(F)Q.remove(F);H.set(E,N)}function G(E){let q=H.get(E);if(q){let O=E.index;if(O!==null){if(q.version<O.version)U(E)}}else U(E);return H.get(E)}return{get:X,update:K,getWireframeAttribute:G}}function GG(J,Q,$){let Z;function W(q){Z=q}let H,Y;function X(q){H=q.type,Y=q.bytesPerElement}function K(q,O){J.drawElements(Z,O,H,q*Y),$.update(O,Z,1)}function U(q,O,R){if(R===0)return;J.drawElementsInstanced(Z,O,H,q*Y,R),$.update(O,Z,R)}function G(q,O,R){if(R===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(Z,O,0,H,q,0,R);let N=0;for(let F=0;F<R;F++)N+=O[F];$.update(N,Z,1)}function E(q,O,R,M){if(R===0)return;let N=Q.get("WEBGL_multi_draw");if(N===null)for(let F=0;F<q.length;F++)U(q[F]/Y,O[F],M[F]);else{N.multiDrawElementsInstancedWEBGL(Z,O,0,H,q,0,M,0,R);let F=0;for(let _=0;_<R;_++)F+=O[_]*M[_];$.update(F,Z,1)}}this.setMode=W,this.setIndex=X,this.render=K,this.renderInstances=U,this.renderMultiDraw=G,this.renderMultiDrawInstances=E}function EG(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function Z(H,Y,X){switch($.calls++,Y){case J.TRIANGLES:$.triangles+=X*(H/3);break;case J.LINES:$.lines+=X*(H/2);break;case J.LINE_STRIP:$.lines+=X*(H-1);break;case J.LINE_LOOP:$.lines+=X*H;break;case J.POINTS:$.points+=X*H;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",Y);break}}function W(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:W,update:Z}}function qG(J,Q,$){let Z=new WeakMap,W=new s0;function H(Y,X,K){let U=Y.morphTargetInfluences,G=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,E=G!==void 0?G.length:0,q=Z.get(X);if(q===void 0||q.count!==E){let z=function(){T.dispose(),Z.delete(X),X.removeEventListener("dispose",z)};if(q!==void 0)q.texture.dispose();let O=X.morphAttributes.position!==void 0,R=X.morphAttributes.normal!==void 0,M=X.morphAttributes.color!==void 0,N=X.morphAttributes.position||[],F=X.morphAttributes.normal||[],_=X.morphAttributes.color||[],L=0;if(O===!0)L=1;if(R===!0)L=2;if(M===!0)L=3;let w=X.attributes.position.count*L,S=1;if(w>Q.maxTextureSize)S=Math.ceil(w/Q.maxTextureSize),w=Q.maxTextureSize;let C=new Float32Array(w*S*4*E),T=new R7(C,w,S,E);T.type=p8,T.needsUpdate=!0;let b=L*4;for(let V=0;V<E;V++){let v=N[V],m=F[V],l=_[V],c=w*S*4*V;for(let i=0;i<v.count;i++){let u=i*b;if(O===!0)W.fromBufferAttribute(v,i),C[c+u+0]=W.x,C[c+u+1]=W.y,C[c+u+2]=W.z,C[c+u+3]=0;if(R===!0)W.fromBufferAttribute(m,i),C[c+u+4]=W.x,C[c+u+5]=W.y,C[c+u+6]=W.z,C[c+u+7]=0;if(M===!0)W.fromBufferAttribute(l,i),C[c+u+8]=W.x,C[c+u+9]=W.y,C[c+u+10]=W.z,C[c+u+11]=l.itemSize===4?W.w:1}}q={count:E,texture:T,size:new x0(w,S)},Z.set(X,q),X.addEventListener("dispose",z)}if(Y.isInstancedMesh===!0&&Y.morphTexture!==null)K.getUniforms().setValue(J,"morphTexture",Y.morphTexture,$);else{let O=0;for(let M=0;M<U.length;M++)O+=U[M];let R=X.morphTargetsRelative?1:1-O;K.getUniforms().setValue(J,"morphTargetBaseInfluence",R),K.getUniforms().setValue(J,"morphTargetInfluences",U)}K.getUniforms().setValue(J,"morphTargetsTexture",q.texture,$),K.getUniforms().setValue(J,"morphTargetsTextureSize",q.size)}return{update:H}}function NG(J,Q,$,Z){let W=new WeakMap;function H(K){let U=Z.render.frame,G=K.geometry,E=Q.get(K,G);if(W.get(E)!==U)Q.update(E),W.set(E,U);if(K.isInstancedMesh){if(K.hasEventListener("dispose",X)===!1)K.addEventListener("dispose",X);if(W.get(K)!==U){if($.update(K.instanceMatrix,J.ARRAY_BUFFER),K.instanceColor!==null)$.update(K.instanceColor,J.ARRAY_BUFFER);W.set(K,U)}}if(K.isSkinnedMesh){let q=K.skeleton;if(W.get(q)!==U)q.update(),W.set(q,U)}return E}function Y(){W=new WeakMap}function X(K){let U=K.target;if(U.removeEventListener("dispose",X),$.remove(U.instanceMatrix),U.instanceColor!==null)$.remove(U.instanceColor)}return{update:H,dispose:Y}}var LH=new qJ,$H=new I7(1,1),VH=new R7,zH=new N$,BH=new V7,ZH=[],WH=[],HH=new Float32Array(16),YH=new Float32Array(9),XH=new Float32Array(4);function s9(J,Q,$){let Z=J[0];if(Z<=0||Z>0)return J;let W=Q*$,H=ZH[W];if(H===void 0)H=new Float32Array(W),ZH[W]=H;if(Q!==0){Z.toArray(H,0);for(let Y=1,X=0;Y!==Q;++Y)X+=$,J[Y].toArray(H,X)}return H}function MJ(J,Q){if(J.length!==Q.length)return!1;for(let $=0,Z=J.length;$<Z;$++)if(J[$]!==Q[$])return!1;return!0}function kJ(J,Q){for(let $=0,Z=Q.length;$<Z;$++)J[$]=Q[$]}function l7(J,Q){let $=WH[Q];if($===void 0)$=new Int32Array(Q),WH[Q]=$;for(let Z=0;Z!==Q;++Z)$[Z]=J.allocateTextureUnit();return $}function OG(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1f(this.addr,Q),$[0]=Q}function FG(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2f(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(MJ($,Q))return;J.uniform2fv(this.addr,Q),kJ($,Q)}}function RG(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3f(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else if(Q.r!==void 0){if($[0]!==Q.r||$[1]!==Q.g||$[2]!==Q.b)J.uniform3f(this.addr,Q.r,Q.g,Q.b),$[0]=Q.r,$[1]=Q.g,$[2]=Q.b}else{if(MJ($,Q))return;J.uniform3fv(this.addr,Q),kJ($,Q)}}function MG(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4f(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(MJ($,Q))return;J.uniform4fv(this.addr,Q),kJ($,Q)}}function kG(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(MJ($,Q))return;J.uniformMatrix2fv(this.addr,!1,Q),kJ($,Q)}else{if(MJ($,Z))return;XH.set(Z),J.uniformMatrix2fv(this.addr,!1,XH),kJ($,Z)}}function DG(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(MJ($,Q))return;J.uniformMatrix3fv(this.addr,!1,Q),kJ($,Q)}else{if(MJ($,Z))return;YH.set(Z),J.uniformMatrix3fv(this.addr,!1,YH),kJ($,Z)}}function LG(J,Q){let $=this.cache,Z=Q.elements;if(Z===void 0){if(MJ($,Q))return;J.uniformMatrix4fv(this.addr,!1,Q),kJ($,Q)}else{if(MJ($,Z))return;HH.set(Z),J.uniformMatrix4fv(this.addr,!1,HH),kJ($,Z)}}function VG(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1i(this.addr,Q),$[0]=Q}function zG(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2i(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(MJ($,Q))return;J.uniform2iv(this.addr,Q),kJ($,Q)}}function BG(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3i(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(MJ($,Q))return;J.uniform3iv(this.addr,Q),kJ($,Q)}}function _G(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4i(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(MJ($,Q))return;J.uniform4iv(this.addr,Q),kJ($,Q)}}function CG(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1ui(this.addr,Q),$[0]=Q}function wG(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2ui(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(MJ($,Q))return;J.uniform2uiv(this.addr,Q),kJ($,Q)}}function IG(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3ui(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(MJ($,Q))return;J.uniform3uiv(this.addr,Q),kJ($,Q)}}function PG(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4ui(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(MJ($,Q))return;J.uniform4uiv(this.addr,Q),kJ($,Q)}}function TG(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;let H;if(this.type===J.SAMPLER_2D_SHADOW)$H.compareFunction=H$,H=$H;else H=LH;$.setTexture2D(Q||H,W)}function AG(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTexture3D(Q||zH,W)}function SG(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTextureCube(Q||BH,W)}function jG(J,Q,$){let Z=this.cache,W=$.allocateTextureUnit();if(Z[0]!==W)J.uniform1i(this.addr,W),Z[0]=W;$.setTexture2DArray(Q||VH,W)}function vG(J){switch(J){case 5126:return OG;case 35664:return FG;case 35665:return RG;case 35666:return MG;case 35674:return kG;case 35675:return DG;case 35676:return LG;case 5124:case 35670:return VG;case 35667:case 35671:return zG;case 35668:case 35672:return BG;case 35669:case 35673:return _G;case 5125:return CG;case 36294:return wG;case 36295:return IG;case 36296:return PG;case 35678:case 36198:case 36298:case 36306:case 35682:return TG;case 35679:case 36299:case 36307:return AG;case 35680:case 36300:case 36308:case 36293:return SG;case 36289:case 36303:case 36311:case 36292:return jG}}function yG(J,Q){J.uniform1fv(this.addr,Q)}function hG(J,Q){let $=s9(Q,this.size,2);J.uniform2fv(this.addr,$)}function fG(J,Q){let $=s9(Q,this.size,3);J.uniform3fv(this.addr,$)}function xG(J,Q){let $=s9(Q,this.size,4);J.uniform4fv(this.addr,$)}function bG(J,Q){let $=s9(Q,this.size,4);J.uniformMatrix2fv(this.addr,!1,$)}function gG(J,Q){let $=s9(Q,this.size,9);J.uniformMatrix3fv(this.addr,!1,$)}function pG(J,Q){let $=s9(Q,this.size,16);J.uniformMatrix4fv(this.addr,!1,$)}function lG(J,Q){J.uniform1iv(this.addr,Q)}function dG(J,Q){J.uniform2iv(this.addr,Q)}function mG(J,Q){J.uniform3iv(this.addr,Q)}function uG(J,Q){J.uniform4iv(this.addr,Q)}function cG(J,Q){J.uniform1uiv(this.addr,Q)}function nG(J,Q){J.uniform2uiv(this.addr,Q)}function sG(J,Q){J.uniform3uiv(this.addr,Q)}function oG(J,Q){J.uniform4uiv(this.addr,Q)}function iG(J,Q,$){let Z=this.cache,W=Q.length,H=l7($,W);if(!MJ(Z,H))J.uniform1iv(this.addr,H),kJ(Z,H);for(let Y=0;Y!==W;++Y)$.setTexture2D(Q[Y]||LH,H[Y])}function aG(J,Q,$){let Z=this.cache,W=Q.length,H=l7($,W);if(!MJ(Z,H))J.uniform1iv(this.addr,H),kJ(Z,H);for(let Y=0;Y!==W;++Y)$.setTexture3D(Q[Y]||zH,H[Y])}function rG(J,Q,$){let Z=this.cache,W=Q.length,H=l7($,W);if(!MJ(Z,H))J.uniform1iv(this.addr,H),kJ(Z,H);for(let Y=0;Y!==W;++Y)$.setTextureCube(Q[Y]||BH,H[Y])}function tG(J,Q,$){let Z=this.cache,W=Q.length,H=l7($,W);if(!MJ(Z,H))J.uniform1iv(this.addr,H),kJ(Z,H);for(let Y=0;Y!==W;++Y)$.setTexture2DArray(Q[Y]||VH,H[Y])}function eG(J){switch(J){case 5126:return yG;case 35664:return hG;case 35665:return fG;case 35666:return xG;case 35674:return bG;case 35675:return gG;case 35676:return pG;case 5124:case 35670:return lG;case 35667:case 35671:return dG;case 35668:case 35672:return mG;case 35669:case 35673:return uG;case 5125:return cG;case 36294:return nG;case 36295:return sG;case 36296:return oG;case 35678:case 36198:case 36298:case 36306:case 35682:return iG;case 35679:case 36299:case 36307:return aG;case 35680:case 36300:case 36308:case 36293:return rG;case 36289:case 36303:case 36311:case 36292:return tG}}class _H{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.setValue=vG(Q.type)}}class CH{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.size=Q.size,this.setValue=eG(Q.type)}}class wH{constructor(J){this.id=J,this.seq=[],this.map={}}setValue(J,Q,$){let Z=this.seq;for(let W=0,H=Z.length;W!==H;++W){let Y=Z[W];Y.setValue(J,Q[Y.id],$)}}}var y$=/(\w+)(\])?(\[|\.)?/g;function KH(J,Q){J.seq.push(Q),J.map[Q.id]=Q}function JE(J,Q,$){let Z=J.name,W=Z.length;y$.lastIndex=0;while(!0){let H=y$.exec(Z),Y=y$.lastIndex,X=H[1],K=H[2]==="]",U=H[3];if(K)X=X|0;if(U===void 0||U==="["&&Y+2===W){KH($,U===void 0?new _H(X,J,Q):new CH(X,J,Q));break}else{let E=$.map[X];if(E===void 0)E=new wH(X),KH($,E);$=E}}}class V6{constructor(J,Q){this.seq=[],this.map={};let $=J.getProgramParameter(Q,J.ACTIVE_UNIFORMS);for(let Z=0;Z<$;++Z){let W=J.getActiveUniform(Q,Z),H=J.getUniformLocation(Q,W.name);JE(W,H,this)}}setValue(J,Q,$,Z){let W=this.map[Q];if(W!==void 0)W.setValue(J,$,Z)}setOptional(J,Q,$){let Z=Q[$];if(Z!==void 0)this.setValue(J,$,Z)}static upload(J,Q,$,Z){for(let W=0,H=Q.length;W!==H;++W){let Y=Q[W],X=$[Y.id];if(X.needsUpdate!==!1)Y.setValue(J,X.value,Z)}}static seqWithValue(J,Q){let $=[];for(let Z=0,W=J.length;Z!==W;++Z){let H=J[Z];if(H.id in Q)$.push(H)}return $}}function UH(J,Q,$){let Z=J.createShader(Q);return J.shaderSource(Z,$),J.compileShader(Z),Z}var QE=37297,$E=0;function ZE(J,Q){let $=J.split(`
`),Z=[],W=Math.max(Q-6,0),H=Math.min(Q+6,$.length);for(let Y=W;Y<H;Y++){let X=Y+1;Z.push(`${X===Q?">":" "} ${X}: ${$[Y]}`)}return Z.join(`
`)}var GH=new y0;function WE(J){b0._getMatrix(GH,b0.workingColorSpace,J);let Q=`mat3( ${GH.elements.map(($)=>$.toFixed(4))} )`;switch(b0.getTransfer(J)){case W$:return[Q,"LinearTransferOETF"];case $J:return[Q,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",J),[Q,"LinearTransferOETF"]}}function EH(J,Q,$){let Z=J.getShaderParameter(Q,J.COMPILE_STATUS),H=(J.getShaderInfoLog(Q)||"").trim();if(Z&&H==="")return"";let Y=/ERROR: 0:(\d+)/.exec(H);if(Y){let X=parseInt(Y[1]);return $.toUpperCase()+`

`+H+`

`+ZE(J.getShaderSource(Q),X)}else return H}function HE(J,Q){let $=WE(Q);return[`vec4 ${J}( vec4 value ) {`,`	return ${$[1]}( vec4( value.rgb * ${$[0]}, value.a ) );`,"}"].join(`
`)}function YE(J,Q){let $;switch(Q){case OW:$="Linear";break;case FW:$="Reinhard";break;case RW:$="Cineon";break;case MW:$="ACESFilmic";break;case DW:$="AgX";break;case LW:$="Neutral";break;case kW:$="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",Q),$="Linear"}return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var p7=new A;function XE(){b0.getLuminanceCoefficients(p7);let J=p7.x.toFixed(4),Q=p7.y.toFixed(4),$=p7.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
`)}function KE(J){return[J.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",J.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(L6).join(`
`)}function UE(J){let Q=[];for(let $ in J){let Z=J[$];if(Z===!1)continue;Q.push("#define "+$+" "+Z)}return Q.join(`
`)}function GE(J,Q){let $={},Z=J.getProgramParameter(Q,J.ACTIVE_ATTRIBUTES);for(let W=0;W<Z;W++){let H=J.getActiveAttrib(Q,W),Y=H.name,X=1;if(H.type===J.FLOAT_MAT2)X=2;if(H.type===J.FLOAT_MAT3)X=3;if(H.type===J.FLOAT_MAT4)X=4;$[Y]={type:H.type,location:J.getAttribLocation(Q,Y),locationSize:X}}return $}function L6(J){return J!==""}function qH(J,Q){let $=Q.numSpotLightShadows+Q.numSpotLightMaps-Q.numSpotLightShadowsWithMaps;return J.replace(/NUM_DIR_LIGHTS/g,Q.numDirLights).replace(/NUM_SPOT_LIGHTS/g,Q.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,Q.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,$).replace(/NUM_RECT_AREA_LIGHTS/g,Q.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,Q.numPointLights).replace(/NUM_HEMI_LIGHTS/g,Q.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,Q.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,Q.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,Q.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,Q.numPointLightShadows)}function NH(J,Q){return J.replace(/NUM_CLIPPING_PLANES/g,Q.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,Q.numClippingPlanes-Q.numClipIntersection)}var EE=/^[ \t]*#include +<([\w\d./]+)>/gm;function f$(J){return J.replace(EE,NE)}var qE=new Map;function NE(J,Q){let $=h0[Q];if($===void 0){let Z=qE.get(Q);if(Z!==void 0)$=h0[Z],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',Q,Z);else throw Error("Can not resolve #include <"+Q+">")}return f$($)}var OE=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function OH(J){return J.replace(OE,FE)}function FE(J,Q,$,Z){let W="";for(let H=parseInt(Q);H<parseInt($);H++)W+=Z.replace(/\[\s*i\s*\]/g,"[ "+H+" ]").replace(/UNROLLED_LOOP_INDEX/g,H);return W}function FH(J){let Q=`precision ${J.precision} float;
...
#define LOW_PRECISION`;return Q}function RE(J){let Q="SHADOWMAP_TYPE_BASIC";if(J.shadowMapType===LQ)Q="SHADOWMAP_TYPE_PCF";else if(J.shadowMapType===uZ)Q="SHADOWMAP_TYPE_PCF_SOFT";else if(J.shadowMapType===K8)Q="SHADOWMAP_TYPE_VSM";return Q}function ME(J){let Q="ENVMAP_TYPE_CUBE";if(J.envMap)switch(J.envMapMode){case j9:case Z9:Q="ENVMAP_TYPE_CUBE";break;case K6:Q="ENVMAP_TYPE_CUBE_UV";break}return Q}function kE(J){let Q="ENVMAP_MODE_REFLECTION";if(J.envMap)switch(J.envMapMode){case Z9:Q="ENVMAP_MODE_REFRACTION";break}return Q}function DE(J){let Q="ENVMAP_BLENDING_NONE";if(J.envMap)switch(J.combine){case EW:Q="ENVMAP_BLENDING_MULTIPLY";break;case qW:Q="ENVMAP_BLENDING_MIX";break;case NW:Q="ENVMAP_BLENDING_ADD";break}return Q}function LE(J){let Q=J.envMapCubeUVHeight;if(Q===null)return null;let $=Math.log2(Q)-2,Z=1/Q;return{texelWidth:1/(3*Math.max(Math.pow(2,$),112)),texelHeight:Z,maxMip:$}}function VE(J,Q,$,Z){let W=J.getContext(),H=$.defines,Y=$.vertexShader,X=$.fragmentShader,K=RE($),U=ME($),G=kE($),E=DE($),q=LE($),O=KE($),R=UE(H),M=W.createProgram(),N,F,_=$.glslVersion?"#version "+$.glslVersion+`
...
`)}}resetView(){this.rotation.identity(),this.targetRotation.identity(),this.distance=6,this.targetDistance=6,this.panX=0,this.panY=0}}customElements.define("ascii-model-viewer",e$);export{e$ as AsciiModelViewer};
