...
export class GlbModelViewer extends HTMLElement {
  ...
  // Wireframe overlays
  private _wireframeOverlays: Map<THREE.Object3D, WireframeOverlay>;
  private wireframeColor: THREE.Color;
  private wireframe: boolean = false;

  // Attribute flags
  private disableZoom: boolean = false;
  private disablePan: boolean = false;
  private disableRotate: boolean = false;
  ...
  private _disposeAllWireframes(): void {
